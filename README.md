...
```javascript
graphemeClusters2iteratorRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-to-grapheme-cluster-iterator-right@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-to-grapheme-cluster-iterator-right@v0.2.1-umd/browser.js"></script>
```
